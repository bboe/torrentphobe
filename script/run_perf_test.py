...
rates = [1, 2, 4, 5, 7, 10, 20, 25, 30, 40, 50, 60, 70, 80, 90, 100]
users = xrange(29000, 29050)
...
if __name__ == "__main__":
    ...
    results = []
    for rate in rates:
        cmd = "httperf --rate=" + str(rate) + " --wlog=n,temp.httperf.input --num-conns=" + str(total_written) + " --hog --http-version=1.0"
        print cmd
